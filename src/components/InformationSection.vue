...
<template>
<div class="col-md-6" v-if="servicesDetail">
    <div class="row">
        <h2 class="d-flex justify-content-center main-title">{{ servicesDetail.data.name }}</h2>
    ...
    <div class="row">
        <p class="fs-5 ms-3 ps-3 me-3 pe-3 mt-3 mb-0">Tentang Service ini :</p>
    </div>
    <div class="row">
